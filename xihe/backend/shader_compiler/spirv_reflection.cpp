...
inline void read_resource_decoration<spv::DecorationNonWritable>(const spirv_cross::Compiler &compiler,
                                                                 ...
                                                                 const ShaderVariant         &variant)
{
	shader_resource.qualifiers |= ShaderResourceQualifiers::kNonWritable;
}
...
inline void read_resource_decoration<spv::DecorationNonReadable>(const spirv_cross::Compiler &compiler,
                                                                 ...
                                                                 const ShaderVariant         &variant)
{
	shader_resource.qualifiers |= ShaderResourceQualifiers::kNonReadable;
}
                               ...
                               const ShaderVariant         &variant)
{
	...
	size_t array_size = 0;
	if (variant.get_runtime_array_sizes().contains(resource.name))
	{
...
inline void read_resource_size(const spirv_cross::Compiler     &compiler,
                               ...
                               const ShaderVariant             &variant)
{
	const auto spirv_type = compiler.get_type(constant.constant_type);
...
template <>
void read_shader_resource<ShaderResourceType::kInput>(const spirv_cross::Compiler &compiler,
                                                      vk::ShaderStageFlagBits      stage,
                                                      std::vector<ShaderResource> &resources,
                                                      const ShaderVariant         &variant)
{
	...
	{
		ShaderResource shader_resource{};
		shader_resource.type   = ShaderResourceType::kInput;
...
template <>
inline void read_shader_resource<ShaderResourceType::kInputAttachment>(const spirv_cross::Compiler &compiler,
                                                                       vk::ShaderStageFlagBits /*stage*/,
                                                                      std::vector<ShaderResource> &resources,
                                                                      const ShaderVariant         &variant)
{
...
template <>
inline void read_shader_resource<ShaderResourceType::kOutput>(const spirv_cross::Compiler &compiler,
                                                              vk::ShaderStageFlagBits      stage,
                                                             std::vector<ShaderResource> &resources,
                                                             const ShaderVariant         &variant)
{
	...
	{
		ShaderResource shader_resource{};
		shader_resource.type   = ShaderResourceType::kOutput;
		shader_resource.stages = stage;
		shader_resource.name   = resource.name;
...
template <>
inline void read_shader_resource<ShaderResourceType::kImage>(const spirv_cross::Compiler &compiler,
                                                             vk::ShaderStageFlagBits      stage,
                                                            std::vector<ShaderResource> &resources,
                                                            const ShaderVariant         &variant)
{
	...
	{
		ShaderResource shader_resource{};
		shader_resource.type   = ShaderResourceType::kImage;
		shader_resource.stages = stage;
		shader_resource.name   = resource.name;
...
template <>
inline void read_shader_resource<ShaderResourceType::kImageSampler>(const spirv_cross::Compiler &compiler,
                                                                    vk::ShaderStageFlagBits      stage,
                                                                   std::vector<ShaderResource> &resources,
                                                                   const ShaderVariant         &variant)
{
	...
	{
		ShaderResource shader_resource{};
		shader_resource.type   = ShaderResourceType::kImageSampler;
		shader_resource.stages = stage;
		shader_resource.name   = resource.name;
...
template <>
inline void read_shader_resource<ShaderResourceType::kImageStorage>(const spirv_cross::Compiler &compiler,
                                                                    vk::ShaderStageFlagBits      stage,
                                                                   std::vector<ShaderResource> &resources,
                                                                   const ShaderVariant         &variant)
{
	...
	{
		ShaderResource shader_resource{};
		shader_resource.type   = ShaderResourceType::kImageStorage;
		shader_resource.stages = stage;
		shader_resource.name   = resource.name;
...
template <>
inline void read_shader_resource<ShaderResourceType::kSampler>(const spirv_cross::Compiler &compiler,
                                                               vk::ShaderStageFlagBits      stage,
                                                              std::vector<ShaderResource> &resources,
                                                              const ShaderVariant         &variant)
{
...
template <>
inline void read_shader_resource<ShaderResourceType::kBufferUniform>(const spirv_cross::Compiler &compiler,
                                                                    vk::ShaderStageFlagBits      stage,
                                                                    std::vector<ShaderResource> &resources,
                                                                    const ShaderVariant         &variant)
{
	...
	{
		ShaderResource shader_resource{};
		shader_resource.type   = ShaderResourceType::kBufferUniform;
		shader_resource.stages = stage;
		shader_resource.name   = resource.name;
...
template <>
inline void read_shader_resource<ShaderResourceType::kBufferStorage>(const spirv_cross::Compiler &compiler,
                                                                    vk::ShaderStageFlagBits        stage,
                                                                    std::vector<ShaderResource> &resources,
                                                                    const ShaderVariant         &variant)
{
	...
	{
		ShaderResource shader_resource;
		shader_resource.type   = ShaderResourceType::kBufferStorage;
		shader_resource.stages = stage;
		shader_resource.name   = resource.name;
...
{
	read_shader_resource<ShaderResourceType::kInput>(compiler, stage, resources, variant);
	read_shader_resource<ShaderResourceType::kInputAttachment>(compiler, stage, resources, variant);
	read_shader_resource<ShaderResourceType::kOutput>(compiler, stage, resources, variant);
	read_shader_resource<ShaderResourceType::kImage>(compiler, stage, resources, variant);
	read_shader_resource<ShaderResourceType::kImageSampler>(compiler, stage, resources, variant);
	read_shader_resource<ShaderResourceType::kImageStorage>(compiler, stage, resources, variant);
	read_shader_resource<ShaderResourceType::kSampler>(compiler, stage, resources, variant);
	read_shader_resource<ShaderResourceType::kBufferUniform>(compiler, stage, resources, variant);
	read_shader_resource<ShaderResourceType::kBufferStorage>(compiler, stage, resources, variant);
}
...
void SpirvReflection::parse_push_constants(const spirv_cross::Compiler &compiler, vk::ShaderStageFlagBits stage, std::vector<ShaderResource> &resources, const ShaderVariant &variant)
{
	...
	for (auto &resource : shader_resources.push_constant_buffers)
	{
		...
		ShaderResource shader_resource{};
		shader_resource.type   = ShaderResourceType::kPushConstant;
		shader_resource.stages = stage;
		shader_resource.name   = resource.name;
