	...
	Pipeline{device}
{
	...
	vk::PipelineColorBlendStateCreateInfo color_blend_state_create_info{
	    ...
	    to_u32(pipeline_state.get_color_blend_state().attachments.size()),
	    reinterpret_cast<const vk::PipelineColorBlendAttachmentState *>(pipeline_state.get_color_blend_state().attachments.data()),
	    {1.0f, 1.0f, 1.0f, 1.0f}};
